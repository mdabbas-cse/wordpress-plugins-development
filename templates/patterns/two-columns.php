...
<div class="wp-block-columns">
  ...
  <div class="wp-block-column">
    ...
    <div class="wp-block-group has-white-color has-black-background-color has-text-color has-background">
      <!-- wp:heading {"textAlign":"center","textColor":"pale-cyan-blue"} -->
      ...
      <p class="has-text-align-center"><strong>Lorem Ipsum</strong> is simply dummy text of the printing and typesetting
      ...
      <div class="wp-block-buttons">
        <!-- wp:button {"align":"center","className":"is-style-layout-border-white-no-fill"} -->
        <div class="wp-block-button aligncenter is-style-layout-border-white-no-fill"><a
            class="wp-block-button__link wp-element-button">CTA One</a></div>
        <!-- /wp:button -->
      </div>
      <!-- /wp:buttons -->
    </div>
  ...
  <div class="wp-block-column">
    ...
    <div class="wp-block-group has-white-color has-black-background-color has-text-color has-background">
      ...
      <!-- wp:paragraph {"align":"center"} -->
      <p class="has-text-align-center">It is a long established fact that a reader will be distracted by the readable
      ...
      <div class="wp-block-buttons">
        <!-- wp:button {"align":"center","className":"is-style-layout-border-white-no-fill"} -->
        <div class="wp-block-button aligncenter is-style-layout-border-white-no-fill"><a
            class="wp-block-button__link wp-element-button">CTA Two</a></div>
        <!-- /wp:button -->
      </div>
      <!-- /wp:buttons -->
    </div>
